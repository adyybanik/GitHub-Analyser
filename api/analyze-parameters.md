...
- **Description**: OpenAI API key (if not set as environment variable)
- **Example**: `openai_api_key=sk-...`
- **Required**: No (if `OPENAI_API_KEY` env var is set)
- **Security Note**: Not recommended for production - use environment variable instead
...
- **Required**: No
- **Default**: `gpt-4o`
- **Valid models**: Any valid OpenAI model (e.g., `gpt-4o`, `gpt-4-turbo`, `gpt-3.5-turbo`)
...
4. **API Key**: Prefer setting `OPENAI_API_KEY` as an environment variable rather than passing it in the URL
